...
function Header () {
    ...
    return (
        ...
        <div className="header__logo">
            <img className="logo__img" src="../public/images/Big.ico" alt="logo" />
        ...
        <ul className="header__nav" >
            <li className="nav__item">
                <a href="https://docs.google.com/document/d/1CX__erSHTnpZPtOHyb8_BYANVMTw_Wip/edit?usp=sharing&ouid=107100755643456077381&rtpof=true&sd=true">
                    <img src="../public/images/rules_logo.svg" alt="rules" /> 
                    <span>ПРАВИЛА</span>
                </a>
            </li>
            <li className="nav__item">
                <a href="https://discord.gg/afsS49GSQw">
                    <img src="../public/images/discord_logo.svg" alt="discord" />
                    <span>ДИСКОРД</span>
                </a>
            </li >
            <li className ="nav__item">
                <a href="#">
                    <img src="../public/images/telegram_logo.svg" alt="telega" />
                    <span>ТЕЛЕГРАМ</span>
                </a>
            </li>
            <li className ="nav__item">
