...
const GameitemsWeapon = [
    ...
    },
    {
        ...
        imageUrl: zezl,
        description:"Он такой большой и такой волшебный",
        Str: 0,
        Dex: 0,
        Int: 1,
        Def: 0,
    ...
    },
    {
        ...
        imageUrl: kolokol,
        description:"Поверхность колокольчика украшена тонким филигранным узором, напоминающим кружево, который, кажется, переливается в мерцающем свете свечей. Во время бега глубокий, звучный звук шаров эхом разносится по залам, призывая верующих к молитве и богослужению. Колокольчик жреца- символ силы веры, напоминание о трансцендентной красоте, которая лежит за пределами мира смертных. Его нежный звон, кажется, нашептывает секреты божественного тем, кто слушает со смиренным сердцем.",
        Str: 0,
        Dex: 0,
        Int: 2,
        Def: 0,
    ...
    },
    {
        ...
        imageUrl: posoh,
        description:"Поверхность посоха испещрена загадочными символами, излучающими слабую, потустороннюю энергию, которая, кажется, наполняет воздух вокруг него. Кончик посоха, отполированный прикосновениями бесчисленных поколений, кажется наполненным тонким мерцающим светом, который, кажется, неумолимо притягивает взгляд к его центру.",
        Str: 0,
        Dex: 0,
        Int: 1,
        Def: 1,
    ...
    },
    {
        ...
        description:"Когда я случил в храме, какой-то святой сказал мне: 'Подержи мои цацки', после у меня и осталась эта печатка ",
        Str: 0,
        Dex: 0,
        Int: 1,
        Def: 2,
    ...
    },
    {
        ...
        title: "Высший посох",
        imageUrl: megaposoh,
        description:"Оружие для тех, кто достиг самой вершины познания секретов этого мира",
        Str: 0,
        Dex: 0,
        Int: 2,
        Def: 1,
    ...
    },
    {
        ...
        imageUrl: anafema,
        description:"Священной властью древних и вечных мы настоящим предаем анафеме Нежить: пусть проклятые духи искусства некромантии будут навеки изгнаны. Пусть их нечестивый облик обветшает и разложится, их глаза будут гореть вечным огнем проклятия, а само их присутствие принесет только тьму и отчаяние. Пусть праведная рука божественного поразит их, и пусть их души навсегда затеряются в пустоте. Пусть те, кто осмелится призвать или заклинать подобные мерзости, будут навеки прокляты тяжестью собственной вины, и пусть их души поглотит та самая тьма, которую они стремятся высвободить. Пусть эта Анафема послужит предупреждением всем, кто осмелится играть с силами смерти, и пусть она послужит напоминанием о вечном гневе, который ожидает тех, кто попытается бросить вызов божественной воле",
        Str: 0,
        Dex: 0,
        Int: 2,
        Def: 2,
    ...
    },
    {
        ...
        description:"Крутите музыкальный инструмент",
        Str: 0,
        Dex: 0,
        Int: 0,
        Def: 0,
